...
<div align="center">
  <img src="" alt="--readme-gif-coming-soon" width="0" height="0">
</div>

<br/>

<div align="center">
  <h1 style="border-bottom: none;"> 💵 SpendSmart 💵 </h1>
</div>
...
<img width="250" alt="erd_diagram" src="app/assets/images/erd_diagram.png">
...
```sh
  cd my-folder
  git clone https://github.com/GhausAliKhan/budget-app.git
```
...
You can deploy this project using your own deployment service like `Render` or `Vercel`.
...
- LinkedIn: [@LinkedInhandle](https://www.linkedin.com/in/ghaus-ali-khan-2a48aa256/)
...
Feel free to check the [issues page](https://github.com/GhausAliKhan/budget-app/issues).
...
- Thanks to all [Microverse](https://www.microverse.org/) community.
